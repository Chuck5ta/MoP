...
void InitializeOpcodes()
{
 ...
 //   OPCODE(MSG_VERIFY_CONNECTIVITY,                             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess            );
    ...
    OPCODE(UNKNOWN_OPCODE,                              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
...
//    OPCODE(CMSG_CHAR_ENUM,                               STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode            );
    ...
    OPCODE(SMSG_ENUM_CHARACTERS_RESULT,                               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(SMSG_LOGIN_SET_TIME_SPEED,                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(SMSG_QUERY_PLAYER_NAME_RESPONSE,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_REALM_QUERY,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRealmQueryOpcode          );
    OPCODE(SMSG_REALM_NAME_QUERY_RESPONSE,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_GUILD_INFO_TEXT,                              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_AUTO_DECLINE_GUILD_INVITES_TOGGLE,               STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleGuildAutoDeclineToggleOpcode );
    //OPCODE(CMSG_AUTO_DECLINE_GUILD_INVITES,                      STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleGuildDeclineOpcode        );
    //OPCODE(CMSG_GUILD_QUERY_RANKS,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryRanksOpcode     );
    //OPCODE(SMSG_GUILD_BANK_QUERY_TEXT_RESULT,                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_READ_ITEM_RESULT_OK,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_READ_ITEM_RESULT_FAILED,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_ITEM_COOLDOWN,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(CMSG_GAME_OBJ_USE,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGameObjectUseOpcode       );
    ...
    OPCODE(SMSG_ON_MONSTER_MOVE,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_MOVE_ROOT,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_FORCE_MOVE_ROOT_ACK,                     STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleMoveRootAck               );
    //OPCODE(SMSG_MOVE_UNROOT,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(SMSG_UPDATE_ACTION_BUTTONS,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SEND_KNOWN_SPELLS,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SPELL_CHANNEL_START,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //OPCODE(SMSG_SPELL_CHANNEL_UPDATE,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    //OPCODE(SMSG_ATTACK_START,                             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_ATTACKER_STATE_UPDATE,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SPELL_HEAL_LOG,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPELL_ENERGIZE_LOG,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
 ...
 //   OPCODE(SMSG_BIND_POINT_UPDATE,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_CURRENCY_LOOT_REMOVED,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_PET_SPELLS_MESSAGE,                              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_QUEST_GIVER_QUERY_QUEST,                  STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQueryQuestOpcode);
    ...
    OPCODE(CMSG_QUEST_GIVER_ACCEPT_QUEST,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverAcceptQuestOpcode);
    ...
    //OPCODE(SMSG_QUESTUPDATE_ADD_CREDIT,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_LOADING_SCREEN_NOTIFY,                             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleLoadScreenOpcode         );
    ...
    //OPCODE(SMSG_SHOW_TAXI_NODES,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_TAXINODE_STATUS_QUERY,                   STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleTaxiNodeStatusQueryOpcode );
    //OPCODE(SMSG_TAXI_NODE_STATUS,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_ACTIVATE_TAXI_REPLY,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_TRAINER_BUY_SPELL,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_PETITION_DECLINE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode     );
    ...
    OPCODE(CMSG_REQUEST_PLAYED_TIME,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                );
    ...
    //OPCODE(SMSG_ENCHANTMENT_LOG,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_TABARD_VENDOR_ACTIVATE,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleTabardVendorActivateOpcode);
    ...
    //OPCODE(CMSG_GM_TICKET_CREATE,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_GM_TICKET_GET_TICKET,                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_CORPSE_QUERY,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode         );
    //OPCODE(CMSG_GMTICKET_DELETETICKET,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketDeleteTicketOpcode);
    //OPCODE(CMSG_GM_TICKET_DELETE_TICKET,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_GM_TICKET_SYSTEM_STATUS,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SPELL_EXECUTE_LOG,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_DEBUGAURAPROC,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPELL_PERIODIC_AURA_LOG,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPELLDAMAGESHIELD,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPELL_NON_MELEE_DAMAGE_LOG,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_AUCTION_HELLO_REQUEST,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode        );
    ...
    //OPCODE(SMSG_QUEST_PUSH_RESULT,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPushResult           );
    ...
    OPCODE(CMSG_BUY_BACK_ITEM,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleBuybackItem               );
    ...
    //OPCODE(CMSG_CONFIRM_RESPEC_WIPE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleTalentWipeConfirmOpcode   );
    ...
    //OPCODE(SMSG_ON_MONSTER_MOVE_TRANSPORT,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_PETITION_RENAME,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode      );
    ...
    //OPCODE(SMSG_BATTLEFIELD_PLAYER_POSITIONS,           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SPLINE_MOVE_SET_WATER_WALK,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SPLINE_MOVE_SET_LAND_WALK,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_RAID_TARGET_UPDATE,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRaidTargetUpdateOpcode    );
    //OPCODE(CMSG_RAID_READY_CHECK,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckOpcode      );
    ...
    //OPCODE(CMSG_SET_DUNGEON_DIFFICULTY,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode);
    ...
    OPCODE(SMSG_SPLINE_MOVE_SET_FLYING,                            STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    ...
    //OPCODE(SMSG_TIME_SYNC_REQUEST,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_RAID_READY_CHECK_CONFIRM,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    //OPCODE(SMSG_GM_MESSAGE_CHAT,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_RAID_READY_CHECK_FINISHED,                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckFinishedOpcode);
    ...
    //OPCODE(SMSG_GUILD_PERMISSIONS_QUERY_RESULTS,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildPermissions          );
    ...
    //OPCODE(SMSG_GUILD_EVENT_LOG_QUERY_RESULT,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_MIRROR_IMAGE_CREATURE_DATA,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SCMSG_RAID_READY_CHECK_ERROR,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(CMSG_GUILD_BANK_QUERY_TEXT,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
...
//    OPCODE(CMSG_CALENDAR_EVENT_INVITE_NOTES,             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SETUP_CURRENCY,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_GAME_OBJ_REPORT_USE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGameobjectReportUse       );
    ...
    OPCODE(CMSG_EQUIPMENT_SET_SAVE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleEquipmentSetSaveOpcode    );
    ...
    OPCODE(SMSG_UPDATE_TALENT_DATA,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_GM_TICKET_RESPONSE,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_GMTICKET_RESOLVE_RESPONSE,               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMResponseResolveOpcode   );
    //OPCODE(SMSG_PETITION_QUERY_RESPONSE,               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_GM_TICKET_CREATE_RESPONSE_TICKET,         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE(CMSG_WORLD_STATE_UI_TIMER_UPDATE,                         STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleUITimeRequestOpcode       );
    ...
    //OPCODE(SMSG_RAID_READY_CHECK_COMPLETED,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_SOCKET_GEMS_RESULT,                             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_MOVE_SET_COLLISION_HEIGHT,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_UPDATE_CURRENCY_WEEK_LIMIT,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_SETUP_CURRENCY,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(SMSG_UPDATE_CURRENCY,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //OPCODE(CMSG_SET_CURRENCY_FLAGS,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetCurrencyFlagsOpcode    );
    //OPCODE(SG_WEEKLY_RESET_CURRENCY,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE(SMSG_REQUEST_PVP_REWARDS_RESPONSE,                             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
