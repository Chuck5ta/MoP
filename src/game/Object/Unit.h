...
class  Unit : public WorldObject
{
    public:
        ...
        */
         ...
         * \see OpcodesList::SMSG_ATTACKER_STATE_UPDATE
         ...
         * \see OpcodesList::SMSG_SPELL_NON_MELEE_DAMAGE_LOG
         ...
         * \ref OpcodesList::SMSG_SPELL_PERIODIC_AURA_LOG.
         * @param pInfo Info about the periodic effect of the \ref Aura
         * \see OpcodesList::SMSG_SPELL_PERIODIC_AURA_LOG
         * \todo Is this actually for the combat log?
         */
