...
/// For CMSG_LFG_GET_STATUS, SMSG_LFG_PARTY_INFO, and SMSG_LFG_UPDATE_SEARCH
struct LFGPlayerStatus
{
    LFGState state;
...
// For SMSG_LFG_BOOT_PROPOSAL_UPDATE
struct LFGBoot
{
...
protected:
    ...
    /// Send SMSG_LFG_PARTY_INFO or SMSG_LFG_UPDATE_SEARCH
