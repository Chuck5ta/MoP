...
void WorldSession::HandleMessagechatOpcode(WorldPacket& recv_data)
{
  ...
  //      case CMSG_MESSAGECHAT_AFK:          type = CHAT_MSG_AFK;            break; // does not exist in MoP
...
//        case CMSG_MESSAGECHAT_ADDON_GUILD:          type = CHAT_MSG_GUILD;          break; // no valid opcode for MoP as yet
//        case CMSG_MESSAGECHAT_ADDON_OFFICER:        type = CHAT_MSG_OFFICER;        break; // no valid opcode for MoP as yet
//        case CMSG_MESSAGECHAT_ADDON_PARTY:          type = CHAT_MSG_PARTY;          break; // no valid opcode for MoP as yet
//        case CMSG_MESSAGECHAT_ADDON_RAID:           type = CHAT_MSG_RAID;           break; // no valid opcode for MoP as yet
