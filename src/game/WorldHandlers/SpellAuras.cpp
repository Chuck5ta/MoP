...
void Aura::HandleAuraMirrorImage(bool apply, bool Real)
{
    ...
    if (apply)
    {
        ...
        if (caster->GetTypeId() == TYPEID_PLAYER)           // TODO - Verify! Does it take a 'pseudo-race' (from display-id) for creature-mirroring, and what is sent in SMSG_MIRROR_IMAGE_CREATURE_DATA
